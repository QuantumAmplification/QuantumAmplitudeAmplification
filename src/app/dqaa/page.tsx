...
import { DQAAModule } from "@/components/dqaa/DQAAModule";
import { ResourceLinks } from "@/components/ResourceLinks";

export default function DQAAPage() {
    return (
            ...
            <header className="absolute top-0 w-full p-6 md:p-10 flex justify-between items-start z-50">
                <div className="flex flex-col gap-4 hover:opacity-100 transition-opacity">
                    <div className="flex flex-col">
                        ...
                        <h2 className="text-xs uppercase tracking-[0.2em] opacity-40 mt-1">Section IV: DQAA</h2>
                    </div>
